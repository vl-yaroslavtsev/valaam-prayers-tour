...
const app = new Framework7({
  ...
  methods: {
    hyphenate(text) {
      ...
      return text
        .replace(
          new RegExp("(" + RusX + ")(" + RusL + RusL + ")", "ig"),
          "$1" + Hyphen + "$2"
        )
        .replace(
          new RegExp(
            "(" + RusV + RusC + RusC + ")(" + RusC + RusC + RusV + ")",
            "ig"
          ),
          "$1" + Hyphen + "$2"
        )
        .replace(
          new RegExp("(" + RusV + RusC + RusC + ")(" + RusC + RusV + ")", "ig"),
          "$1" + Hyphen + "$2"
        )
        .replace(
          new RegExp("(" + RusV + RusC + ")(" + RusC + RusC + RusV + ")", "ig"),
        ...
        .replace(
          new RegExp("(" + RusC + RusV + ")(" + RusC + RusV + ")", "ig"),
          "$1" + Hyphen + "$2"
        )
        .replace(
          new RegExp("(" + RusV + RusC + ")(" + RusC + RusV + ")", "ig"),
          "$1" + Hyphen + "$2"
        )
        .replace(
          new RegExp("(" + RusC + RusV + ")(" + RusV + RusL + ")", "ig"),
          "$1" + Hyphen + "$2"
        );
    },
    plural(value, data) {
      ...
      if ((value > 10 && value < 20) || digit === 0 || digit > 4) idx = 2;
      else if (digit === 1) idx = 0;
      else idx = 1;
...
/**
 * iOS 14.6 криво запускает indexedDB. Пытаемся это пофиксить
 * @param {*} isSafari
 * @returns
 */
function idbReady(isSafari) {
